module.exports = {
  siteMetadata: {
    ...
    author: `Ty Hitzeman`,
    image: "banner.jpg",
    siteUrl: "https://switchback.tech",
    mailchimp_endpoint:
      "https://tech.us18.list-manage.com/subscribe/post?u=cf05d1d7d6f957a5f11cea628&amp;id=b6b72a31e0",
  ...
  plugins: [
    ...
    `gatsby-plugin-offline`, // PWA & offline functionality
    ...
    },
    {
      ...
      options: {
        host: "https://switchback.tech",
        sitemap: "https://switchback.tech/sitemap.xml",
